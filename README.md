...
The amount of mental effort required to process the information presented, to manage the learning environment or the materials being used, and to learn or remember the task at hand results in cognitive load.
...
Accessing such huge amounts of information can add significant cognitive load, which can in turn lead to poorer performance on tasks. When designing learning experiences or work environments, it is important to consider how best to minimize the cognitive load associated with accessing information. This may include providing clear and concise instructions, organizing materials in an easily searchable way, and chunking information into manageable pieces.
